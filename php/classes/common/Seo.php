<?
    ...
    class Seo
    {
        ...
        const
            DEFAULT_SHORT = "Шаблон лендинга для старта проекта",
            DEFAULT_TITLE = "Шаблон лендинга для старта проекта",
            DEFAULT_DESCRIPTION = "Шаблон лендинга для старта проекта",
