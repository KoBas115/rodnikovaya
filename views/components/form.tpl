<form class="form form-request {$formClass}">
    <div class="request-loader" style="display: none;">
        <img alt="Подождите несколько секунд" height="100" width="100" src="/img/svg/loader.svg">
    </div>
    ...
    {if $formPrivacy}
        <div class="input__check">
            <label class="input__privacy">
                ...
                <span class="input__check-text privacy-modal">Согласие на обработку персональных данных</span>
            </label>
