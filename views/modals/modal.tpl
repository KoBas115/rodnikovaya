<div class="intopModal intopModal-{$eng}">
    ...
    <span class="intopModal__close-text">Закрыть</span> 
    ...
    <div class="intopModal__content">
        <div class="request-content__head">
            <button class="request-close arcticmodal-close">
                {include "blocks/components/icon.tpl" icon=[
                    "class" => "svg-sprite-icon icon-close",
                    "name" => "close"
                ]}
            </button>
        </div>
